    ...
    <div className="admin__layout" style={{ display: 'flex', background: '#f6f7fb', minHeight: '100vh' }}>
      ...
      >
        ...
        <nav className="admin__nav" style={{ display: 'grid', gap: 6 }}>
          ...
          <Link className="admin__nav-link" to="/admin/team" style={{ display: 'flex', alignItems: 'center', gap: 12, color: '#111827', textDecoration: 'none', padding: '10px 12px', borderRadius: 6, background: isActive('/admin/team') ? '#eef2ff' : 'transparent' }}>
            <span style={{ width: 18, display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            ...
            <span className="admin__nav-text">Team Management</span>
          </Link>
          <Link className="admin__nav-link" to="/admin/quiz" style={{ display: 'flex', alignItems: 'center', gap: 12, color: '#111827', textDecoration: 'none', padding: '10px 12px', borderRadius: 6, background: isActive('/admin/quiz') && !isActive('/admin/quiz/submissions') ? '#eef2ff' : 'transparent' }}>
            <span style={{ width: 18, display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            ...
            <span className="admin__nav-text">Ramadan Quiz 2026</span>
          </Link>
          <Link className="admin__nav-link" to="/admin/quiz/submissions" style={{ display: 'flex', alignItems: 'center', gap: 12, color: '#111827', textDecoration: 'none', padding: '10px 12px', borderRadius: 6, background: isActive('/admin/quiz/submissions') ? '#eef2ff' : 'transparent', marginLeft: '24px' }}>
            <span style={{ width: 18, display: 'inline-flex', alignItems: 'center', justifyContent: 'center' }}>
              <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
            ...
            <span className="admin__nav-text">Quiz Submissions</span>
          </Link>
        </nav>
