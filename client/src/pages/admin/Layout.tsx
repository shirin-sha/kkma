    ...
    <div className="admin__layout" style={{ display: 'flex', background: '#f6f7fb' }}>
      ...
      >
        ...
        <nav className="admin__nav" style={{ display: 'grid', gap: 6 }}>
          <Link className="admin__nav-link" to="/admin/dashboard" style={{ display: 'flex', alignItems: 'center', gap: 12, color: '#111827', textDecoration: 'none', padding: '10px 12px', borderRadius: 6 }}>
            ...
            <span className="admin__nav-text">Dashboard</span>
          </Link>
